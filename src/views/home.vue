<template>
  <div
    ...
    style="
      background-image: url('https://images.unsplash.com/photo-1455849318743-b2233052fcff?q=80&w=2969&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    "
  >
    <!-- Hero Section -->
    <section class="bg-black bg-opacity-50 text-white text-center py-16 px-6">
      <h1 class="text-4xl font-bold">Learn Anything, Anytime</h1>
      <p class="mt-2 text-lg">Join thousands of learners worldwide</p>
      <div class="mt-4">
        <input
          type="text"
          placeholder="Search courses..."
          class="px-4 py-2 w-full max-w-md text-gray-900 rounded-md shadow-md"
        />
      </div>
    </section>
    ...
    <section class="bg-gray-100 text-center py-16">
      <h2 class="text-2xl font-semibold">Become an Instructor</h2>
    ...
    <footer class="bg-gray-800 text-white text-center py-2">
      <section class="py-2 bg-gray-100 text-gray-900">
        <div
          class="container mx-auto flex flex-col justify-around p-2 text-center md:p-10 lg:flex-row"
        >
          <div class="flex flex-col justify-center lg:text-left">
            <p
              class="mb-1 text-sm font-medium tracking-widest uppercase text-gray-600"
            >
              Learning Management System (LMS)
            </p>

            <h1 class="py-2 text-xl font-medium leading-tight title-font">
          ...
          >
            <button
              class="inline-flex items-center px-6 py-3 rounded-lg bg-gray-600 text-gray-50"
            >
              <svg
            ...
            <button
              class="inline-flex items-center px-5 py-3 rounded-lg bg-gray-600 text-gray-50"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
